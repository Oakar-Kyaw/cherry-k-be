...
module.exports = (app) => {
  ...
  app
    .route("/api/treatment-lists")
    .get(catchError(treatmentList.listAllTreatmentLists));

  app
    .route("/api/treatment-lists/mobile")
    .get(catchError(treatmentList.listAllTreatmentLists));

  app
    .route("/api/treatment-lists-filter")
    .get(verifyToken, catchError(treatmentList.filterTreatmentLists));

  app
    .route("/api/treatment-lists-search")
    .post(verifyToken, catchError(treatmentList.searchTreatmentLists));

  app
    .route("/api/treatment-lists/treatment/:id")
    .get(verifyToken, catchError(treatmentList.getRelatedTreatments));
};
